namespace GoblinzMechanics.Game
{
    ...
    public class BolderControler : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (GoblinGameManager.Instance.GameState != GoblinGameManager.GameStateEnum.Playing || GoblinGameManager.Instance.IsWin) return;
